  ...
  return <>
    <section className="card">
      <div className="card-head">
        <div><h2>Jadwal tersimpan</h2><span className="muted" style={{ fontSize: 12 }}>Jadwal dapat mengirim broadcast harga atau BC custom yang dibuat dari Kirim Telegram.</span></div>
